...
#bad notation - 2L2l means for a particular combination, like 2e2mu
#4l means total for 4e+2e2mu+2e2tau+4mu+2mu2tau+4tau
JHUXSHZZ2L2la1             = ufloat(     7.1517044,  0.00027591496) / 2
JHUXSHZZ2L2la2             = ufloat(     2.5850323,  0.00010874196) / 2
JHUXSHZZ2L2la3             = ufloat(      1.095479,  5.6780596e-05) / 2
JHUXSHZZ2L2lL1             = ufloat( 4.8755556e-08,    1.75784e-12) / 2
JHUXSHZZ2L2lL1Zg           = ufloat( 1.2489117e-07,  5.6567346e-12) / 2
JHUXSHZZ2L2la1a2           = ufloat(     26.074307,  0.00094875635) / 2
JHUXSHZZ2L2la1a3           = ufloat(     14.277409,   0.0005409516) / 2
JHUXSHZZ2L2la1L1           = ufloat(    0.23726108,  2.1955163e-05) / 2
JHUXSHZZ2L2la1L1Zg         = ufloat(     13.220602,  0.00053706572) / 2
JHUXSHZZ2L2la2a3           = ufloat(     14.221651,  0.00063763008) / 2
JHUXSHZZ2L2la2L1           = ufloat(     2.3200652,  0.00014040255) / 2
JHUXSHZZ2L2la2L1Zg         = ufloat(     13.391687,  0.00049246945) / 2
JHUXSHZZ2L2la3L1           = ufloat(     14.264343,  0.00051778249) / 2
JHUXSHZZ2L2la3L1Zg         = ufloat(     14.364768,  0.00054679129) / 2
JHUXSHZZ2L2lL1L1Zg         = ufloat(     15.488892,  0.00063476605) / 2

JHUXSHZZ2L2leL = 1.4347981E+01 / 2
JHUXSHZZ2L2leR = 1.3952140E+01 / 2
...
JHUXSHZZ4la1               = JHUXSHZZ2L2la1 / fractionofevents(481392, 2213962)
JHUXSHZZ4la2               = JHUXSHZZ2L2la2 / fractionofevents(328041, 1457394)
JHUXSHZZ4la3               = JHUXSHZZ2L2la3 / fractionofevents(335387, 1454067)
JHUXSHZZ4lL1               = JHUXSHZZ2L2lL1 / fractionofevents(328209, 1473060)
JHUXSHZZ4lL1Zg             = JHUXSHZZ2L2lL1Zg / fractionofevents(199932, 952440)
JHUXSHZZ4la1a2             = JHUXSHZZ2L2la1a2 / fractionofevents(104189, 474877)
JHUXSHZZ4la1a3             = JHUXSHZZ2L2la1a3 / fractionofevents(110420, 496912)
JHUXSHZZ4la1L1             = JHUXSHZZ2L2la1L1 / fractionofevents(99542, 500000)
JHUXSHZZ4la1L1Zg           = JHUXSHZZ2L2la1L1Zg / fractionofevents(107541, 500000)
#JHUXSHZZ4la2a3             = JHUXSHZZ2L2la2a3 / fractionofevents(
#JHUXSHZZ4la2L1             = JHUXSHZZ2L2la2L1 / fractionofevents(
#JHUXSHZZ4la2L1Zg           = JHUXSHZZ2L2la2L1Zg / fractionofevents(
#JHUXSHZZ4la3L1             = JHUXSHZZ2L2la3L1 / fractionofevents(
#JHUXSHZZ4la3L1Zg           = JHUXSHZZ2L2la3L1Zg / fractionofevents(
#JHUXSHZZ4lL1L1Zg           = JHUXSHZZ2L2lL1L1Zg / fractionofevents(
